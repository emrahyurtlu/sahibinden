    ...
    <div class="row">
        <div class="column-3">
            ...
            <ul class="leftnav-category">
                <li class="leftnav-category-item category-acil-acil margin-bottom-5"><a href="#">Acil Acil</a></li>
                <li class="leftnav-category-item category-fiyati-dusen margin-bottom-5"><a href="#">Fiyatı Düşenler</a>
                </li>
            ...
            <ul class="leftnav-category">
                <li class="leftnav-category-item category-hikayeni-paylas margin-bottom-5"><a href="#">Hikayeni
                        Paylaş</a></li>
                <li class="leftnav-category-item category-efsane-ilanlar margin-bottom-5"><a href="#">Efsane İlanlar</a>
                </li>
            ...
            <ul class="leftnav-category margin-left-15">
        ...
        <div class="column-9">
            ...
            <img src="assets/images/ads/ad-2.png" class="justify-content-center" alt="Ad 2">

            <div class="clearfix"></div>

            <h3 class="category-title font-weight-bold margin-top-16">
                Projeler
                <small>
            ...
            <div class="projectCard float-left mr-2 mb-2">
                <a href="#"><img src="assets/images/projects/project1.jpg" class="img-fluid" alt="Image"></a>
                <a href="#" class="font-weight-bold display-block">Avcılar Exclusive (İzmir / Bayraklı)</a>
                <p class="display-block mb-0"><span class="font-weight-bold">m<sup>2</sup>:</span> 100 m<sup>2</sup> -
                    173
                    m<sup>2</sup></p>
                <p class="display-block mb-0"><span class="font-weight-bold">Teslim Tarihi:</span> Haziran 2021</p>
            </div>

            <div class="projectCard float-left mr-2 mb-2">
                <a href="#"><img src="assets/images/projects/project2.jpg" class="img-fluid" alt="Image"></a>
                <a href="#" class="font-weight-bold display-block">Torun Center (İstanbul / Şişli)</a>
                <p class="display-block mb-0"><span class="font-weight-bold">m<sup>2</sup>:</span> 100 m<sup>2</sup> -
                    173
                    m<sup>2</sup></p>
                <p class="display-block mb-0"><span class="font-weight-bold">Teslim Tarihi:</span> Hemen Teslim</p>
            </div>
            ...
            <div class="product-card">
                <img src="assets/images/thumbs/interesting/thmb_144190656dfv.jpg" class="img-fluid" alt="Image">
                <a href="#">2015 Highline Dsg...</a>
            </div>

            <div class="product-card">
                <img src="assets/images/thumbs/interesting/thmb_373185768lb6.jpg" class="img-fluid" alt="Image">
                <a href="#">2015 Highline Dsg...</a>
            </div>

            <div class="product-card">
                <img src="assets/images/thumbs/interesting/thmb_397694640n4m.jpg" class="img-fluid" alt="Image">
                <a href="#">2015 Highline Dsg...</a>
            </div>

            <div class="product-card">
                <img src="assets/images/thumbs/interesting/thmb_655603344p63.jpg" class="img-fluid" alt="Image">
                <a href="#">2015 Highline Dsg...</a>
            </div>

            <div class="product-card">
                <img src="assets/images/thumbs/interesting/thmb_755149533mye.jpg" class="img-fluid" alt="Image">
                <a href="#">2015 Highline Dsg...</a>
            </div>

            <div class="product-card">
                <img src="assets/images/thumbs/interesting/thmb_37114466063f.jpg" class="img-fluid" alt="Image">
                <a href="#">2015 Highline Dsg...</a>
            </div>

            <div class="product-card">
                <img src="assets/images/thumbs/interesting/thmb_70933087579r.jpg" class="img-fluid" alt="Image">
                <a href="#">2015 Highline Dsg...</a>
            </div>

            <img src="assets/images/ads/ad-2.png" alt="Ad 2">
            ...
            <div class="row">
                <div class="column-12">
                    ...
                    <img src="assets/images/ads/ad-3.png" class="justify-content-center" alt="Ad 3">
                </div>
            </div>
            ...
            <ul class="list-unstyled badge-list">
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">İkinci el</span></a></li>
                <li class="list-inline-item"><a href="#"><span
                                class="badge badge-home">iPhone 11 Pro Max</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">iPhone 11 Pro</span></a>
                </li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Redmi Note 7</span></a>
                </li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Apple Watch S5</span></a>
                </li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">P30 Lite</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">İkinci El Araba</span></a>
                </li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">DJI Drone</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Bebek Arabası</span></a>
                </li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Lastik Fiyatları</span></a>
                </li>
            </ul>
            ...
            <ul class="list-unstyled badge-list">
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Boyacı</span></a></li>
                <li class="list-inline-item"><a href="#"><span
                                class="badge badge-home">Evden Eve Nakliye</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Mantolama</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Su Tesisatı</span></a></li>
                <li class="list-inline-item"><a href="#"><span
                                class="badge badge-home">Doğal Gaz Tesisatı</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Oto Boya</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Oto Tamiri</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Elektrikçi</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Çilingir</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Plaka</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Parke</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Mutfak Yenileme</span></a>
                </li>
            </ul>
            ...
            <ul class="list-unstyled badge-list">
                ...
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Ofis Elemanı</span></a>
                </li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Satış</span></a></li>
                <li class="list-inline-item"><a href="#"><span
                                class="badge badge-home">Müşteri Hizmetleri</span></a></li>
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">İstanbul İş İlanları</span></a>
                </li>
                <li class="list-inline-item"><a href="#"><span
                ...
                <li class="list-inline-item"><a href="#"><span class="badge badge-home">Antalya İş İlanları</span></a>
                </li>
            </ul>
